...
public class Constants {
    ...
    public final static int _FRAG_detailVins = 2;
    public final static int _FRAG_distance = 3;
    public final static int _FRAG_MAPS = 4;
    public final static int _FRAG_MAPS_rayon = 5;
